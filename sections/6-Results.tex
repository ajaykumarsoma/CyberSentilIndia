...
Table~\ref{tab:language} shows performance across languages. English and Hindi achieve highest scores (F1: 0.904, 0.884), while Telugu, Tamil, and Malayalam show slightly lower performance (F1: 0.862, 0.852, 0.843). This gap correlates with training sample counts (English: 5,250 vs. Malayalam: 2,100), indicating that low-resource languages would benefit from data augmentation.
