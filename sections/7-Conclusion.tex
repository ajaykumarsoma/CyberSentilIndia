...
results demonstrate a macro F1 of 0.872, outperforming 
all baselines, with LIME and attention maps providing 
interpretability. Future work will focus on data 
