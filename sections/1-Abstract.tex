...
The model achieves a macro F1 of 0.872 and accuracy of 0.881, outperforming the
strongest text-only baseline (XLM-R) by 3.9 F1 points and demonstrating consistent
performance across all five languages (macro F1: 0.858). The framework offers a
